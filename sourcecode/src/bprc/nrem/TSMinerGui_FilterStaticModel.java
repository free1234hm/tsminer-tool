...
/**
 *Class implements a table model, which is used for selected genes based on
 * static input
 */
public class TSMinerGui_FilterStaticModel extends AbstractTableModel {
	/**
	 ...
	 * parameters
	 */
	public TSMinerGui_FilterStaticModel(Object[][] data, String[] columnNames) {
