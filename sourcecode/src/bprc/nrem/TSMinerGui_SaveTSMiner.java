...
/**
 * Class for window to specify to save the current TSMiner main interface as an
 * image
 */
public class TSMinerGui_SaveTSMiner extends JPanel {
	 ...
	 */
	public TSMinerGui_SaveTSMiner(TSMinerGui theTSMinerGui, final JFrame theFrame) {
		...
		TSMinerGui_ImageFilter filter = new TSMinerGui_ImageFilter();
		...
		final TSMinerGui ftheTSMinerGui = theTSMinerGui;
		...
		theChooser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (state.equals(JFileChooser.CANCEL_SELECTION)) {
					...
					try {
						PCanvas canvas = ftheTSMinerGui.getCanvas();
						...
						String szext = TSMinerGui_ImageFilter.getExtension(f);
						if (szext.equalsIgnoreCase("svg")) {
							...
							// PCanvas aCanvas)
							ftheTSMinerGui.canvas.paintComponent(svgGenerator);
