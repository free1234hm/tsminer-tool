...
public class TSMiner_Timeiohmm {
	...
	HashMap<String, List<String>> activeTF;
	HashMap<String, List<String>> activeDEpvalue;
	HashMap<String, List<String>> repressTF;
	HashMap<String, List<String>> repressDEpvalue;
	...
	public void displayTempMap() throws Exception {
		...
		try {
			javax.swing.SwingUtilities.invokeAndWait(new Runnable() {
				public void run() {
					progressTSMinerGui = new TSMinerGui(fthishmm, treecopy,
							brealXaxisDEF, dYaxisDEF, dXaxisDEF,
							nKeyInputTypeDEF, dKeyInputXDEF, dpercentDEF,
							"(Not Final Model)", dnodekDEF, npermutationval);
					edu.umd.cs.piccolo.PCanvas.CURRENT_ZCANVAS = null;
					progressTSMinerGui.setLocation(15, 40);
					progressTSMinerGui.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

					progressTSMinerGui.setVisible(true);
					progressTSMinerGui.addWindowListener(new WindowAdapter() {
						public void windowClosing(WindowEvent we) {
							progressTSMinerGui.closeWindows();
						}
					});
				}
			});
