...
public class TSMinerGui_EdgeTable2 extends JPanel implements ActionListener {
	 ...
	 */
	public TSMinerGui_EdgeTable2(TSMinerGui theTSMinerGui, JDialog dialog, JFrame frame1,
			TSMiner_Timeiohmm theTimeiohmm, TSMiner_Timeiohmm.Treenode ptr,
			BigInteger npathID, int ndepth, int nchild, int ntype, boolean broot, int npermutationval) {
		...
		nf7.setMaximumFractionDigits(7);
				...
				if(ptr.nextptr[nchild].deTF[0].length > 5){
					...
					columnNames[5] = theTimeiohmm.theDataSet.dsamplemins[ndepth]+" DE q-value";
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (szCommand.equals("pathway")) {
			...
			Integer colorID = (Integer) theTSMinerGui.htLineIDtoColorID.get(ndepth
					+ ";" + npathID);
			Color initcolor = (Color) theTSMinerGui.htColorIDtoColor.get(colorID);
