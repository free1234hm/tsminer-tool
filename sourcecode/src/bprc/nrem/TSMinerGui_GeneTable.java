 ...
 * in TSMiner
 */
public class TSMinerGui_GeneTable extends JPanel implements ActionListener,
		ChangeListener {
	 ...
	 */
	public TSMinerGui_GeneTable(JFrame theFrame, TSMiner_DataSet theDataSet,
			TSMiner_Timeiohmm theTimeiohmm, double[][][] bindingpval,
		...
		if (szCommand.equals("staticsummary")) {
			javax.swing.SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					...
					TSMinerGui_StaticSummaryTable newContentPane = new TSMinerGui_StaticSummaryTable(
