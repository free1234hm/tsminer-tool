 ...
 */
public class TSMinerGui_StaticSummaryTable extends JPanel implements
		ActionListener {
	 ...
	 */
	public TSMinerGui_StaticSummaryTable(JFrame theFrame, TSMiner_DataSet theDataSet,
			TSMiner_Timeiohmm theTimeiohmm, double[][] bindingpvalTF,
			...
			for (int nel = 0; nel < theTimeiohmm.bindingData.existingBindingValuesSorted.length; nel++) {
				if (theTimeiohmm.bindingData.existingBindingValuesSorted[nel] != 0) {
					...
					tabledata[nrowindex][5] = ""
							+ TSMinerGui_EdgeTable2.doubleToSz(StatUtil
