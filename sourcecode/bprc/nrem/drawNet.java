...
import bprc.core.TableModelST;
import bprc.core.TableSorter;
...
public class drawNet {
	...
	private String[] Names = { "Pathway", "Num TF", "Num TG", "Num PG", "Num Total", "Per." };
	...
	public void drawPic(List<List<String>> genetype, List<List<String>> networkfile, String[][] pathwaylist, 
		...
		*/
		...
		sorter = new TableSorter(new TableModelST(pathwaylist, Names));
		...
		sorter2 = new TableSorter(new TableModelST(TFlist, Names2));
		...
		GroupLayout.SequentialGroup hParalGroup02 = mainLayout.createSequentialGroup().addComponent(savemap).addGap(10).addComponent(savepathwaytable).addGap(10).addComponent(savetftable).addGap(10).addComponent(savenetwork).addGap(5);
