 ...
 * functions used by TSMiner
 */
public class TSMiner_GoAnnotations extends GoAnnotations {
	 ...
	 */
	TSMiner_GoAnnotations(String szorganismsourceval, String szxrefsourceval,
     ...
     *
     */
	public void buildRecTSMiner(TSMiner_Timeiohmm.Treenode treeptr, String[] genenames) {
	...
	public void findmins(HashMap htGOtoMinSplit, HashMap htGOtoMinOverall,
			TSMiner_Timeiohmm.Treenode treeptr, String[] genenames,
			HashMap htParentGO) {
		if (treeptr != null) {
